          ...
          <div class="card smallPageHeader">
             <div class="card-header">
                <div class="divPageTitle">
                   ...
                   <div class="btnRight">
                      <a id="btnView" href="<?php echo e(route('WithdrawalHistory')); ?>" class="btn btn-danger hvr-sweep-to-right collapsed">
                         ...
                         <div class="form-group col-md-12">
                            ...
                            <div class="row">
                               <div class="form-group col-md-6">
                                  ...
                                  <input value="<?php echo e($user_details->withdrawable); ?>" type="text" class="form-control" maxlength="50" readonly="readonly">
                               </div>
                            </div>
                            <div class="row">
                               <div class="form-group col-md-6">
...
<?php echo $__env->make('includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;<?php /**PATH C:\xampp\htdocs\VELOCIUM\resources\views/Pages/transactions/WithdrawalRequest.blade.php ENDPATH**/ ?>