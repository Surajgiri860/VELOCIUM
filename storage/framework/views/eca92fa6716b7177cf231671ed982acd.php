...
<?php echo $__env->make('includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
               <div class="content">
                  ...
                  <div class="row">
                     <div class="col-12 text-right">
                        <a href="<?php echo e(route('WithdrawalRequest')); ?>" class="btn btn-warning">Claim My Earning</a>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        <div class="card card-chart">
                           <div class="card-header  ">
                              <div class="divPageTitle">
                                 ...
                                 <div class="btnRight">
                                    <a  href="<?php echo e(route('Activate.index')); ?>" class="btn btn-success hvr-sweep-to-right collapsed" style="margin-left: 10px;">
                           ...
                           <div class="card-body" style="min-height: 190px;">
                              <div class="row">
                                 <div class="col-6 col-md-6 taskrounbd">
                                    <div class="cashsales">
                                       <figure><?php echo e(number_format($user_data->activation_balance, 2)); ?></figure>
                                       <h2 style="text-transform: none;">Activation Balance</h2>
                                    </div>
                                 </div>
                                 <div class="col-6 col-md-6 taskrounbd">
                                    <div class="receipts">
                                       <figure id="lblEWallet"><?php echo e(number_format($user_data->withdrawable, 2)); ?></figure>
                           ...
                           <div class="card-body " style="height: 190px; overflow: auto">
                              <table class="tblJobOrderItem">
                                 <tr>
                                    ...
                                    <th style="width: 80px; text-align: right;" id="lblStaking"><?php echo e(number_format($user_data->total_investment ,2)); ?></th>
                                 </tr>
                                 <tr>
                                    <th class="tdjobid">Daily Earning</th>
                                    <th style="text-align: right;" id="lblDailyEarning"><?php echo e(number_format($total_daily_roi,2)); ?></th>
                                 </tr>
                                 
                                 <tr>
                                    <th class="tdjobid">Received Earning <span id="lblEarningPer" class="text-warning" style="font-family: 'Segoe UI'"></span></th>
                                    <th style="text-align: right;" id="lblEarning"><?php echo e(number_format($witdrowal,2)); ?></th>
                                 </tr>
                                 <tr>
                                    ...
                                    <th style="width: 100px; text-align: right;" id="lblBalanceEarning"><?php echo e(number_format($Balance_Earning,2)); ?></th>
                                 </tr>
                              </table>
                           </div>
                        </div>
                        ...
                        <div class="card card-chart card-profile">
                           <div class="card-header">
                              <h5 class="card-title">My Profile
                                 <input type="text" id="referralLink" value="<?php echo e($referralLink); ?>" class="form-control" style="display: none">
                           ...
                           <div class="card-body" style="padding-top: 10px; min-height: 180px;">
                              ...
                              <div class="profiledetail-right profiledetail">
                                 ...
                                 <div class="profile-memberid">ID: <span ><?php echo e($user_data->referal_code); ?></span></div>
                                 <div class="profile-text profile-sponsorid">Referral: <span><?php echo e($user_data->referal_by); ?></span></div>
                                 <div class="profile-text profile-regdate">Date of Registration: <span ><?php echo e($user_data->created_at->format('Y-m-d')); ?></span></div>
                                 <div class="profile-text profile-activedate">Name: <span ><?php echo e($user_data->name); ?></span></div>
                                 <div class="profile-text profile-activedate">
                                    Active Status: <?php if($user_data->status ==0 ): ?>
                                    <span >Inactive</span>
                                    <?php else: ?>
                                    <span >Active</span>
                                 <?php endif; ?>
                           ...
                           <div class="card-body " style="height: auto; overflow: auto">
                              <table id="tblMyEarning" class="tblJobOrderItem">
                                 <tr>
                                    ...
                                    <th style="width: 100px; text-align: right;" id="tdROIIncome"><?php echo e(number_format($user_data->staking_balance,2)); ?></th>
                                 </tr>
                                 
                                 <tr>
                                    <th style="width: 80px;" class="tdjobid"> Level Reward</th>
                                    <th style="width: 100px; text-align: right;" id="tdSonsorLevelIncome"><?php echo e(number_format($user_data->level_balance,2)); ?></th>
                                 </tr>
                                 <tr>
                                    <th style="width: 80px;" class="tdjobid">Direct Income</th>
                                    <th style="width: 100px; text-align: right;"><?php echo e(number_format($user_data->direct_balance,2)); ?></th>
                                 </tr>
                                 <tr>
                                    <th style="width: 80px;" class="tdjobid">Royalty Rewards</th>
                                    <th style="width: 100px; text-align: right;" id="tdROILevelIncome"><?php echo e(number_format($user_data->royalty_balance,2)); ?></th>
                                 </tr>
                                 <tr>
                                    <td colspan="2" class="tdWIPDtl"><span class="wipqty">Pending Amount: <i id="tdPROILevelIncome"><?php echo e($pending_reward); ?></i></span></td>
                                 </tr>
                              </br>
                             
                              <?php if($user_reward->count() > 0): ?>
                              
                                  <tr>
                                    <td colspan="2" class="tdWIPDtl">
                                       <?php $__currentLoopData = $user_reward; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <span class="wipqty"> 
                                          <form action="<?php echo e(route('claim.reward', $reward->id)); ?>" method="POST">
                                              <?php echo csrf_field(); ?>
                                 ...
                                 <div class="card-body " style="height: 180px; overflow: auto">
                                    <table class="tblJobOrderItem tblBusinessDetail">
                                       <tr>
                                          ...
                                          <?php if($InvestmentHistoryCount > 0): ?>
                                          <td style="width: 100px; text-align: right;" ><?php echo e($InvestmentHistoryCount); ?></td>
                                          <?php else: ?>
                                       ...
                                       <tr>
                                          ...
                                          <td style="width: 100px; text-align: right;" id="tdTotalDirectPV"><?php echo e($Active_Directs); ?></td>
                                       </tr>
                                       <tr>
                                          <td style="width: 80px;" class="tdjobid"><i class="fa fa-angellist"></i>&nbsp;Total Active Team</td>
                                          <td style="width: 100px; text-align: right;" id="tdTotalTeamPV"><?php echo e($indirectUsersCount); ?></td>
                                       </tr>
                                       <tr>
                                          <td style="width: 80px;" class="tdjobid"><i class="fa fa-angellist"></i>&nbsp;Power Leg Team</td>
                                          <td style="width: 100px; text-align: right;" id="tdTotalTeamPV"><?php echo e($power_leg_business); ?></td>
                                       </tr>
                                       <tr>
                                          <td style="width: 80px;" class="tdjobid"><i class="fa fa-angellist"></i>&nbsp;Other Leg Team</td>
                                          <td style="width: 100px; text-align: right;" id="tdTotalTeamPV"><?php echo e($other_team_business); ?></td>
                                       </tr>
                                       <tr>
                                          <td style="width: 80px;" class="tdjobid"><i class="fa fa-angellist"></i>&nbsp;Total Team Business</td>
                                          <td style="width: 100px; text-align: right;" id="tdTotalTeamBusiness"><?php echo e($total_business); ?></td>
                                       </tr>
                                    </table>
                                 </div>
                              </div>
                               ...
                               <div class="card" style="margin-top: 10px;">
                                   ...
                                   <div class="card-body" style="height: auto;">
                                       <table id="tblMyPurchase" class="tblwipitem table table-striped" style="border: none;">
                                           ...
                                           <tbody>
                                               <?php $__currentLoopData = $user_investments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $investment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <tr>
                                                   <td><?php echo e(number_format($investment->amount, 2)); ?></td> <!-- Format the amount -->
                                                   <td><?php echo e($investment->created_at->format('Y-m-d')); ?></td> <!-- Format the date -->
                                               </tr>
                                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                           </tbody>
                                       </table>
              ...
              <script>
               ...
               <?php /**PATH C:\xampp\htdocs\VELOCIUM\resources\views/Pages/Dashboard.blade.php ENDPATH**/ ?>