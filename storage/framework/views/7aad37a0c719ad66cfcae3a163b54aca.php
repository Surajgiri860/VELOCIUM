                               ...
                               <table  class="table table-striped table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="tbldata_info">
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td  class="sorting_asc DTCR_tableHeader" tabindex="0" aria-controls="tbldata" style="width: 193.531px; cursor: pointer;" aria-sort="ascending" aria-label="Date: activate to sort column descending" ><?php echo e($Invest_req->created_at); ?></td>
                                        <td style="width: 135px" data-column-index="2" class="sorting_disabled"  aria-label="Amount"><?php echo e($Invest_req->amount); ?></td>
                                        <?php if($Invest_req->status == 1): ?>
                                        ...
                                        <td class="sorting_disabled" style="width: 276.604px;" aria-label="Status">
                                            ...
                                            <form action="<?php echo e(route('invest_req.update', $Invest_req->id)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?> <!-- Laravel's method spoofing to make this a PUT request -->
                                                <button type="submit" class="btn btn-danger hvr-sweep-to-right">Activate</button>
                                             </form>
                                             <form action="<?php echo e(route('reject_request',$Invest_req->id)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\VELOCIUM\resources\views/Admin/investment/index.blade.php ENDPATH**/ ?>