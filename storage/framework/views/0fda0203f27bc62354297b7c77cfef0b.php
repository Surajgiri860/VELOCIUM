...
<html>
   <head>
      ...
      <link href="<?php echo e(asset('assets/fonts/Segoe-UI/FontSegoeUI.css')); ?>" rel="stylesheet" />
      <link href="https://fonts.googleapis.com/css?family=Rajdhani:400,600,700&amp;display=swap" rel="stylesheet" />
      <link href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/fonts/font-baroquescript.css')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/fixedColumns.dataTables.min.css')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/jquery-ui.css?version=04112022')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/CustomDataTable.css?version=04112022')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/bootstrap.min.css')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/hover.css')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/paper-dashboard.css?version=3072023')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/Custom.css?version=04112022')); ?>" rel="stylesheet" />
      <link href="<?php echo e(asset('assets/css/search.css')); ?>" rel="stylesheet" />
      ...
      <script src="<?php echo e(asset('assets/js/datatable/dataTables.fixedColumns.min.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/ColReorderWithResize.js')); ?>"></script>
      ...
      <script src="<?php echo e(asset('assets/js/jquery.ui.autocomplete.html.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/jquery.timepicker.min.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('assets/js/jquery.mask.min.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('assets/js/CustomComboBox.js?version=04112022')); ?>"></script>
      ...
      <script src="<?php echo e(asset('assets/js/themejs.js?version=2')); ?>"></script>
      <link href="<?php echo e(asset('assets/css/Dashboard.css?v=8')); ?>" rel="stylesheet" />
   ...
   <body>
      ...
      <div class="sidebar" id="sidebar" data-color="white" data-active-color="danger">
         <div class="menu-bar">
            <div class="logo">
               ...
               <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt style="max-width: 90%; width: 112px">
               </a>
            </div>
               ...
               <ul class="nav">
                  ...
                  <li data-toggle="collapse" data-target="#Report" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Report">
                        <li><a href="<?php echo e(route('admin.show_all_user')); ?>">User List</a></li>
                  ...
                  <li data-toggle="collapse" data-target="#Profile" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Profile">
                        <li><a href="<?php echo e(route('invest_req.index')); ?>">Pending</a> </li>
                        <li><a href="<?php echo e(route('admin.active')); ?>">Active</a> </li>
                        <li><a href="<?php echo e(route('admin.reject')); ?>">Reject</a> </li>
                     </ul>
                  </li>
                <li data-toggle="collapse" data-target="#Network" class="collapsed">
                  ...
                  <ul class="sub-menu collapse" id="Network">
                     <li><a href="<?php echo e(route('add_fund.pending')); ?>">Pending</a></li>
                     <li><a href="<?php echo e(route('add_fund.approved')); ?>">Approved</a></li>
                     <li><a href="<?php echo e(route('add_fund.rejected')); ?>">Rejected</a></li>
                  </ul>
               </li>
                  <li data-toggle="collapse" data-target="#Registration" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Registration">
                        <li><a href="<?php echo e(route('active_user_id.index')); ?>">Active User ID</a> </li>
                        <li><a href="<?php echo e(route('dummy_id')); ?>">Dummy User ID</a> </li>
                     </ul>
                  </li>
                  <li data-toggle="collapse" data-target="#TransactionSwap" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="TransactionSwap">
                        <li><a href="<?php echo e(route('withdrawal_requests.index')); ?>">Pending</a> </li>
         ...
         <div class="container-fluid">
            <div class="navbar-wrapper" style="width: 55%">
               ...
               <div class="mobile-logo">
                  <img src="<?php echo e(asset('assets/img/logo.png')); ?>" width="50px"/> </div>
            </div>
      ...
      <?php if(session('success')): ?>
                ...
                <?php endif; ?><?php /**PATH C:\xampp\htdocs\VELOCIUM\resources\views/layouts/header.blade.php ENDPATH**/ ?>