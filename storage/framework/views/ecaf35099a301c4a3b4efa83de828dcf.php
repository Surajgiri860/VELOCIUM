...
<html>
   ...
   <body>
               ...
               <ul class="nav">
                  ...
                  <li data-toggle="collapse" data-target="#Profile" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Profile">
                        <li><a href="<?php echo e(route('profile.index')); ?>">Update Profile</a> </li>
                        <li><a href="<?php echo e(route('UploadDocument.index')); ?>">KYC Verification</a> </li>
                     </ul>
                  </li>
                  <li data-toggle="collapse" data-target="#Network" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Network">
                        <li><a href="<?php echo e(route('Network.index')); ?>">Direct Team</a> </li>
                        <li><a href="<?php echo e(route('TeamList')); ?>">Team List</a> </li>
                  ...
                  <li data-toggle="collapse" data-target="#Registration" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Registration">
                        <li><a href="<?php echo e(route('register')); ?>">Add New Registration</a> </li>
                        <li><a href="<?php echo e(route('Activate.index')); ?>">Activate/Upgrade My ID</a> </li>
                      </ul>
                  </li>
                  ...
                  <li data-toggle="collapse" data-target="#TransactionSwap" class="collapsed" aria-expanded="false">
                     ...
                     <li><a href="<?php echo e(route('Royalty')); ?>">Rewards</a> </li>
                      </ul>
                     </li>
                  <li data-toggle="collapse" data-target="#Transaction" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Transaction">
                        <li><a href="<?php echo e(route('addfund')); ?>">Add Fund</a> </li>
                        <li><a href="<?php echo e(route('WithdrawalRequest')); ?>">Claim My Earning</a> </li>
                        <li><a href="<?php echo e(route('DepositHistory')); ?>">Deposit History</a> </li>
                        <li><a href="<?php echo e(route('WithdrawalHistory')); ?>">Withdrawal History</a> </li>
                        </ul>
                  </li>
                  ...
                  <li data-toggle="collapse" data-target="#Report" class="collapsed">
                     ...
                     <ul class="sub-menu collapse" id="Report">
                        <li><a href="<?php echo e(route('ReportROI')); ?>">ROI Income</a></li>
                        <li><a href="<?php echo e(route('DirectIncome')); ?>">Direct Income</a></li>
                        <li><a href="<?php echo e(route('LevelIncome')); ?>">Level Income</a></li>
      ...
      <?php if(session('success')): ?>
                ...
                <?php endif; ?><?php /**PATH C:\xampp\htdocs\VELOCIUM\resources\views/includes/header.blade.php ENDPATH**/ ?>