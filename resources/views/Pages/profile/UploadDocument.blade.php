                ...
                <div class="card-body form_design" id="divWalletAddress">
                    ...
                    <div class="current-details">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value" id="currentWalletAddress">{{ auth()->user()->wallet_address ?? 'Not Set' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Account Holder Name:</span>
                            <span class="detail-value" id="currentAccountName">{{ auth()->user()->account_name ?? 'Not Set' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Account Number:</span>
                            <span class="detail-value" id="currentAccountNumber">{{ auth()->user()->account_number ?? 'Not Set' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">IFSC Code:</span>
                            <span class="detail-value" id="currentIFSC">{{ auth()->user()->ifsc_code ?? 'Not Set' }}</span>
                        </div>
                    </div>
