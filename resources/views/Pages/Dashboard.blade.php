...
<!-- ================= POPUP HTML ================= -->
<div id="tripPopup" class="trip-overlay">
    <div class="trip-popup-content">
        <button class="trip-close" onclick="closePopup()">&times;</button>
        <img src="{{ asset('images/trip-banner.jpg') }}" class="trip-img" alt="Trip Banner" onerror="this.src='https://via.placeholder.com/700x400?text=Trip+Banner'">
    </div>
</div>
...
<!-- ================= POPUP SCRIPT (TESTING - har refresh par dikhega) ================= -->
<script>
...
// Popup dikhane ke liye - TESTING PURPOSE (har refresh par dikhega)
document.addEventListener("DOMContentLoaded", function() {
    console.log("DOM loaded - showing popup");
...
document.addEventListener("click", function(event) {
    var popup = document.getElementById("tripPopup");
    var popupContent = document.querySelector(".trip-popup-content");
    
    if (popup && popup.classList && popup.classList.contains("show")) {
...
// Console se check karne ke liye
